...
Сначала вам нужно отправить запрос **HTTP GET** на [https://bmclapi2.bangbang93.com/optifine/\[MC\_VERSION\]](https://bmclapi2.bangbang93.com/optifine/1.19.2).
...
|      \[PATH\_TO\_YOUR\_OPTIFINE\_JAR]      |               Путь к вашему установочному пакету Optifine               |
