---
url: /ruRU/projbobcat/authenticators/yggdrasil.md
---
...
| \[CUSTOM\_AUTH\_SERVER]  | Необязательное поле, настраиваемый адрес сервера аутентификации, это поле обычно предоставляется сторонним поставщиком услуг аутентификации, если не заполнено, используется официальный адрес сервера аутентификации Mojang |
